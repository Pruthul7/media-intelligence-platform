        ...
        insert into `news_pipeline`.`mart_geo_sentiment__dbt_backup`
        ("country_code", "day", "article_count", "avg_sentiment", "negative_count", "positive_count", "negativity_pct", "top_narratives")-- storage/dbt/models/marts/mart_geo_sentiment.sql
