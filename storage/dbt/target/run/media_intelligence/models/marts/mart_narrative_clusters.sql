        ...
        insert into `news_pipeline`.`mart_narrative_clusters__dbt_backup`
        ("narrative_cluster_id", "narrative_label", "hour", "mention_count", "avg_weighted_sentiment", "negative_mentions", "positive_mentions", "sources", "sample_titles")-- storage/dbt/models/marts/mart_narrative_clusters.sql
