        ...
        insert into `news_pipeline`.`mart_sentiment_by_source__dbt_backup`
        ("source_domain", "source_tier", "source_credibility", "hour", "article_count", "positive_count", "negative_count", "neutral_count", "avg_weighted_sentiment", "positivity_pct")-- storage/dbt/models/marts/mart_sentiment_by_source.sql
