        ...
        insert into `news_pipeline`.`mart_crisis_signals__dbt_backup`
        ("hour", "narrative_cluster_id", "narrative_label", "article_count", "negative_count", "avg_sentiment", "mean_count", "std_count", "volume_zscore", "crisis_probability")-- mart_crisis_signals.sql
