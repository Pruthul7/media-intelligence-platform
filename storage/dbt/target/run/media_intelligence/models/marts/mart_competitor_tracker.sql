        ...
        insert into `news_pipeline`.`mart_competitor_tracker__dbt_backup`
        ("entity", "hour", "mention_count", "avg_weighted_sentiment", "negative_mentions", "positive_mentions", "neutral_mentions", "avg_source_credibility", "controversy_score")-- storage/dbt/models/marts/mart_competitor_tracker.sql
